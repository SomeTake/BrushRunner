...
bool HitCheckPToS(PLAYER *pP, PAINTSYSTEM *pS);												// プレイヤーとペイントシステムの当たり判定
void HitCheckSToS(PAINTSYSTEM *pSysBlack, PAINTSYSTEM *pSysColor);							// ペイントシステム同士の当たり判定（引数1:黒用、引数2:カラー用）
